...
local function SetButtonHandler(button, text)
  handledBtn = button
  SetButtonFontColor(handledBtn, GetLoginStageWaitingFontColor())
  local delay = 0
  local cnt = -1
...
local function SelectServer(worldIndex, zoneId)
  ...
  if zoneId == nil then
    ...
    if X2Debug:GetDevMode() then
      local testZoneId = backgroundWindow.zoneList:GetSelectedValue()
  ...
  PlayUISound("login_stage_world_select")
...
local function CheckRaceCongestionFull(congestion)
...
local function SortWorldListInfo(info)
  ...
  for i = 1, count do
    if mainWindow.worldList[i] == nil then
      ...
      function widget:SelChangedProc(selDataViewIdx, selDataIdx, selDataKey, doubleClick)
        if 0 < selDataIdx and selDataIdx <= #self.datas then
          ...
          elseif GetEnableCreateCharacter_worldSelect() then
            ...
            enterWorldBtn:Enable(0 < characterCount)
          end
...
function warningLabel:UpdateWarningText()
  if X2World:IsPreSelectCharacterPeriod() then
    ...
    warningLabel:SetText(locale.server.max_character_count_warning(MAX_CHARACTOR, X2World:GetTotalCharactersDefaultLimit(), X2World:GetTotalCharactersExpandableLimit()))
  end
...
function queueWindow.cancelBtn:OnClick()
  X2LoginCharacter:CancelWorldQueue()
  queueWindow:Show(false)
end

queueWindow.cancelBtn:SetHandler("OnClick", queueWindow.cancelBtn.OnClick)

function queueWindow.exitBtn:OnClick()
  Console:ExecuteString("quit")
end

queueWindow.exitBtn:SetHandler("OnClick", queueWindow.exitBtn.OnClick)

local function InitZoneList()
  ...
  for k = 1, zoneCount do
    ...
    zoneList:AppendItem("[" .. tostring(zoneInfo.id) .. "] " .. zoneInfo.name, zoneInfo.id)
  end
  zoneList:Select(0)
  zoneList.listbox:Show(false)
end
...
local worldSelectEvents = {
  ...
  READY_TO_CONNECT_WORLD = function()
    queueWindow:Show(false)
    X2LoginCharacter:ConnectToWorld()
    PlayUISound("login_stage_ready_to_connect_world")
    isConnecting = true
  end,
...
function GetWorldListInfo()
  local serverName = {
    "\237\130\164\237\148\132\235\161\156\236\130\172",
    "\236\152\164\237\130\164\235\147\156\235\130\152",
    "\237\131\128\236\150\145",
    "\236\167\132",
    "\235\169\156\235\166\172\236\130\172\235\157\188",
    "\235\163\168\237\130\164\236\154\176\236\138\164",
    "\236\149\132\235\158\128\236\160\156\235\184\140",
    "\236\151\144\236\149\136\235\130\152",
    "\236\149\132\235\158\128\236\160\156\235\185\132\236\149\132",
    "\236\152\172\235\161\156",
    "\236\157\180\235\133\185",
    "\235\130\152\236\157\180\235\167\136",
    "\235\141\184\237\148\188\235\130\152\235\147\156",
    "\236\151\144\236\149\132\235\130\152\235\147\156",
    "\236\185\180\237\142\152\235\165\180\235\130\152\236\155\128",
    "\235\178\160\235\130\152\235\160\136\236\130\172\236\138\164",
    "\236\151\144\237\142\152\235\166\172\236\155\128",
    "\237\158\136\235\157\188\235\167\136\236\185\184\235\147\156",
    "\236\151\144\235\133\184\236\149\132",
    "\235\169\148\236\150\180",
    "\237\148\132\235\160\136\237\140\140\236\132\184\236\138\164",
    "\237\142\152\235\158\128",
    "\237\133\140\235\160\136\235\130\152",
    "\236\149\136\235\141\184\237\148\132"
  }
  serverTable = {}
  for i = 1, testServerCount do
    local data = {}
    data.id = i
    data.name = serverName[i] or string.format("server_%d", i)
    data.characterCount = 0
    data.congestion = math.floor(math.random(0, 2))
    data.available = math.random(0, 100) < 90 and true or false
    data.raceCongestions = {
      nuian = math.random(0, 2),
      elf = math.random(0, 2),
      ferre = math.random(0, 2),
      hariharan = math.random(0, 2)
    }
    serverTable[#serverTable + 1] = data
  end
  if testServerCount ~= 0 then
  ...
  for i = 1, #world do
    world[i].characterCount = X2World:GetWorldCharactersCount(world[i].id)
    local flag = true
